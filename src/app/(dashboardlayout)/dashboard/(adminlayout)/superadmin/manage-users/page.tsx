            ...
            {paginated.map((user, index) => (
              <tr key={user._id} className="border-t bg-white">
                ...
                <td className="flex items-center gap-2 py-4">
                  <button
                    className="text-xs text-white px-3 py-2 rounded-md bg-green-500 flex items-center gap-2"
                  ...
                  <button
                    ...
                    className="text-xs text-white px-3 py-2 rounded-md bg-blue-500 hover:bg-blue-600 transition"
                  >
                    Give Signup Bonus
                  </button>
