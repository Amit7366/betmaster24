...
export default function ReferralCard() {
  ...
  const referralLink = "https://www.sbm777.com/register?refId=SBM47376";
  ...
  return (
    <div className="bg-[#0B1622] text-white w-full min-h-screen mx-auto rounded-lg p-4 space-y-4 shadow-lg">
      ...
      <div className="bg-[#111d2c] flex flex-col items-center text-center">
        ...
        />
        <p className="text-lg font-semibold">Amit Singh</p>
        <p className="text-xs text-gray-300">
          You&apos;ll get 15% of your friend&apos;s task reward as referral
          commission
        </p>
      </div>
